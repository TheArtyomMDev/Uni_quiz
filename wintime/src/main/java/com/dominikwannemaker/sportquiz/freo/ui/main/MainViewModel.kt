...
import com.dominikwannemaker.sportquiz.freo.data.datasource.APIService
...
import com.dominikwannemaker.sportquiz.freo.data.repository.QuestionRepository
...
class MainViewModel(
    ...
    private val _topicFlow: MutableStateFlow<QuizTopic> = MutableStateFlow(QuizTopic.Soccer)
